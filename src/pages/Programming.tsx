                  ...
                  <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2 text-xs text-[var(--text-tertiary)]">
                        ...
                        <span>Generated by {solution.source === 'groq' ? 'Groq (3-Phase Pipeline)' : solution.modelUsed}</span>
                      </div>
                      <div className="flex gap-2">
                        {explanation && (
                          <button
                            ...
                            className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-indigo-500/10 text-indigo-400 border border-indigo-500/20 hover:bg-indigo-500/20 transition-all disabled:opacity-50 text-xs font-medium"
                          >
                            <Volume2 size={14} className={voiceLoading ? 'animate-pulse' : ''} />
                            {voiceLoading ? 'Voice...' : 'Explain'}
                          </button>
                        )}
